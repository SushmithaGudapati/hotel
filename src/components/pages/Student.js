    ...
    render() {
        ...
        return (
            <div className="mid container">
                <div style={{ display: 'flex', justifyContent: 'space-between' }}>
                    <div className="card" style={{ width: "12rem" }}>
                        <div className="card-body">
                            ...
                            <h6 className="card-subtitle mb-2 text-muted">Your Room</h6>
                            <p onClick={() => this.onBatchSelect('Book')} className="card-text" style={{
                                cursor: 'pointer',
                                color: '#00a4eb'
                            }}>Book Here</p>
                        </div>
                ...
                <br />
                <label htmlFor="find" style={{ marginLeft: '14px' }}><h5>Check Info</h5></label>
